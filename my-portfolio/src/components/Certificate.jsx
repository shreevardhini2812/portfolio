  ...
  return (
    <div className='p-10 bg-blue-900 h-115'>
        ...
        <div className='flex flex-row gap-20 p-2'>
            ...
            <a href='https://drive.google.com/file/d/1mYZsLnZunDIsV4IeJFh29WyNO-boMPXx/view?usp=sharing'><button className='cursor-pointer text-blue-900 hover:text-gray-400 text-3xl'><FaArrowCircleRight /></button></a>
        </div>
        <div className='flex flex-row gap-20 p-2'>
            <div className='text-black text-xl'>Salesforce Platform Developer I - Cognizant Technology Solutions</div>
            <a href='https://drive.google.com/file/d/17FR2qGOJMuxptYjzq0r7ZfrJcnBSM6rC/view?usp=drive_link'><button className='cursor-pointer text-blue-900 hover:text-gray-400 text-3xl'><FaArrowCircleRight /></button></a>
        </div>
        </div>
    </div>
  )
