...
const About = () => {
  return (
    <div id="about" className='h-140'>
        <div className='p-5 text-3xl font-bold pl-140 text-white bg-blue-900 '>About Me</div>
        <div className='text-3xl p-2 pl-120'>MERN Stack Developer</div>
        <div className='flex flex-row gap-10 p-10 justify-between items-center'>
        <div className='p-5'><img src="/photo1.png" width="300" height="300"/></div>
        ...
        <div className='flex flex-row p-10 pl-90 gap-5 font-bold'>
            <button className='bg-gray-400 rounded-lg p-2'>MongoDB</button>
            <button className='bg-gray-400 rounded-lg p-2'>React.js</button>
            <button className='bg-gray-400 rounded-lg p-2'>Node.js</button>
            <button className='bg-gray-400 rounded-lg p-2'>Express.js</button>
            <button className='bg-gray-400 rounded-lg p-2'>TailwindCSS</button>
            <button className='bg-gray-400 rounded-lg p-2'>Javascript</button>
        </div>
    </div>
  )
}
